...
export class UpdateUserDto {
  ...
  @ApiPropertyOptional({ example: 'password', description: 'Пароль пользователя' })
  @IsString()
  @IsOptional()
  password?: string;

  @ApiPropertyOptional({ example: 'ADMIN', enum: Role, description: 'Роль пользователя (ADMIN / EMPLOYEE)' })
